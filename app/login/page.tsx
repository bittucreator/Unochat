    ...
    <div className="container flex h-screen items-center justify-center">
      <Card className="mx-auto max-w-md w-full">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-lg">Sign in to access your dashboard and tools</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          {error && error !== "auth" && (
            <Alert variant="destructive" className="mb-4">
              <AlertDescription>There was a problem with your authentication. Please try again.</AlertDescription>
            </Alert>
          )}
