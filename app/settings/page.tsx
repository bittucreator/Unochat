            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input id="name" defaultValue={user.user_metadata.full_name || ""} placeholder="Your full name" />
                </div>
                <div className="space-y-2">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="font-medium">Conversion Notifications</h3>
                    <p className="text-sm text-muted-foreground">Receive notifications when conversions are complete</p>
                  </div>
                  <Switch defaultChecked />
                </div>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm">
                    You have used <strong>0</strong> of <strong>1,000</strong> API requests this month.
                  </p>
                </div>
