...
import { Check, ChevronRight, Code, Palette, Layout, Zap, Settings } from "lucide-react"
          ...
          <TabsContent value="layout" className="space-y-4">
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Select value={layout} onValueChange={(value: NextjsGenerationOptions["layout"]) => setLayout(value)}>
          ...
          <TabsContent value="features" className="space-y-4">
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch id="use-authentication" checked={useAuthentication} onCheckedChange={setUseAuthentication} />
              </div>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  ...
                  {performanceOptimization === "basic" && "Includes code splitting, lazy loading, and basic caching."}
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value: NextjsGenerationOptions["accessibilityLevel"]) => setAccessibilityLevel(value)}
                >
